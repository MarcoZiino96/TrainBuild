        ...
        <nav class="navbar">
            ...
            <c:if test="${not empty sessionScope.utente}">
                <ul class="navbar-nav">
                    ...
                    <div class="boxLink">
                        <li class="nav-item"><a class="nav-link" href="home">Home</a></li>
                        <li class="nav-item"><a class="nav-link" href="order">Ricerca & Gestisci </a></li>
                        <li class="nav-item"><a class="nav-link" href="prenota">Prenota</a></li>
                        <li class="nav-item"><a class="nav-link" href="miePrenotazioni">Mie Prenotazioni</a></li>
                    </div>

                    <div class="boxLink">
                        <li class="nav-item"><p class="username">${sessionScope.utente.username}</p></li>
                        <li class="nav-item">
